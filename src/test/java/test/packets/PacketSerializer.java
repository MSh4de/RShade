package test.packets;


import test.world.BlockPosition;
...
public class PacketSerializer {
    ...
    public void writePosition(BlockPosition blockPosition) throws IOException {
        this.ensureOutputStream();
        this.writeLong(((long) (blockPosition.getX() & 0x3FFFFFF) << 38) | ((blockPosition.getY() & 0xFFF) << 26) | (blockPosition.getZ() & 0x3FFFFFF));
    }
